...
export default function ClientAdminLayout(props) {
  ...
  const canAccessClientAdmin = () => {
    return ['master', 'advertiser_admin', 'advertiser_staff', 'agency_manager'].includes(role);
  };
  ...
  const getRoute = () => {
    return window.location.pathname !== '/clientadmin/full-screen-maps';
  };
            ...
            <Portal>
              <Box>
                <Navbar
                  {...rest}
                  onOpen={onOpen}
                  logoText={'Growth Analytics - Client Admin'}
            ...
            {getRoute() ? (
              ...
              >
                <Routes>
                  ...
                  <Route
                    path="/"
                    element={<Navigate to="/clientadmin/default" replace />}
                  />
                </Routes>
              </Box>
            ) : null}
